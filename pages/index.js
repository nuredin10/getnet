        ...
        <div className='container'>
          ...
          <div className='wrapper'>
            ...
            <div className='blocks'>
              ...
              <div onMouseEnter={mouseEnter2} onMouseLeave={mouseLeave2} className={`${block2} three block `} onClick={() => setCount(2)}><p>PRACTICE AREA</p></div> {/*${count % 2 != 0 ? 'longBlock2' : 'shortBlock2'}*/}
            ...
            {homeVisible ? (
              <div className='front'>
                ...
                <div className='titles'>
                  <div onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} id="textbox">
